        ...
        <div class="row d-flex align-items-center no-gutters">
            <div id="mision" class="col-md-6 pos-relative">
                <figure style="height:400px;overflow:hidden;">
                    <img src="{$path.images}ab_2.png" alt="Background" class="img-cover" style="transition:400ms;">
                </figure>
                <div class="pos-absolute d-flex align-items-center justify-content-center flex-column p-20 p-md-40" style="top:0px;right:0px;bottom:0px;left:0px;background-color:rgba(0,0,0,0.4);transition:400ms;">
            ...
            <div id="vision" class="col-md-6">
                <figure style="height:400px;overflow:hidden;">
                    <img src="{$path.images}ab_3.png" alt="Background" class="img-cover" style="transition:400ms;">
                </figure>
                <div class="pos-absolute d-flex align-items-center justify-content-center flex-column p-20 p-md-40" style="top:0px;right:0px;bottom:0px;left:0px;background-color:rgba(0,0,0,0.4);transition:400ms;">
