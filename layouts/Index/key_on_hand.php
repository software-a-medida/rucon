...
<main>
    <section class="pos-relative" style="height:50vh;">
        <figure style="height:100%;">
            <img src="{$path.images}hd_1.png" alt="Background" class="img-cover">
        </figure>
        <div class="pos-absolute d-flex align-items-center p-20 p-md-40" style="top:0px;right:0px;bottom:0px;left:0px;background-color:rgba(0,0,0,0.4);"></div>
    </section>
    ...
    <section class="pos-relative" style="height:50vh;">
        <figure style="height:100%;">
            <img src="{$path.images}hd_2.png" alt="Background" class="img-cover">
        </figure>
